...
<div class="space-y-8 fade-in">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg p-8 mb-6">
        <div class="flex justify-between items-center">
            <h1 class="text-3xl font-bold text-white">Manage Companies</h1>
    ...
    <div class="bg-white shadow-md rounded-xl overflow-hidden mb-6">
        <div class="p-4">
            <form method="GET" action="{{ route('categories.index') }}">
                <div class="relative">
                    <input type="text" name="search" placeholder="Search companies..." value="{{ $query ?? '' }}" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('inventory.category', $category) }}" class="inline-flex items-center p-1.5 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            ...
                            <form action="{{ route('categories.destroy', $category) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="return confirm('Are you sure you want to delete this Company and potentially its Subcategories?')" class="inline-flex items-center p-1.5 border border-gray-300 rounded-md text-sm font-medium text-red-600 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
